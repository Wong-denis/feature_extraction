...
def get_parser():
    ...
    parser.add_argument('--outPath', type=str, default="", help='where should the output image or images be store')
...
before = cv2.imread(args.img1)
after = cv2.imread(args.img2)
